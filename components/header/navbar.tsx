...
export default function Navbar({ title }: NavbarProps) {
  return (
    <nav className="flex items-center gap-10">
      <Link href="/">
        <h1 className="font-[IntegralCF] text-[32px] leading-none">{title}</h1>
      </Link>
      ...
      <ul className="flex gap-6">
        <li className="group relative">
          ...
          <ul className="container w-28 h-28 bg-[#F2F0F1] absolute invisible group-hover:visible mt-2 rounded-[20px]">
            <h3>иди нахуй</h3>
          </ul>
        </li>
        <li>
